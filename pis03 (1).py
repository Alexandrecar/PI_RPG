...
Original file is located at
    https://colab.research.google.com/drive/19HzFAiFOB6ZZP4mULjtusunfabPXUCTA
"""
...
def checa_receita(receita, despensa):
  ...
  return(min(quociente1, quociente2, quociente3))

def receita_feita(receita,despensa):
  ingrediente1 = list(receita)[0]
  ingrediente2 = list(receita)[1]
  ingrediente3 = list(receita)[2]
  despensa[ingrediente1] -= receita[ingrediente1]
  despensa[ingrediente2] -= receita[ingrediente2]
  despensa[ingrediente3] -= receita[ingrediente3]
